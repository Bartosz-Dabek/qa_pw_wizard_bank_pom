...
test('Assert manager can add new customer', async ({ page }) => {
  ...
  */
  ...
  await customersPage.checkCustomerFirstName(firstName);
  await customersPage.checkCustomerLastName(lastName);
  await customersPage.checkCustomerPostCode(postCode);
  await customersPage.checkCustomerMissingAccountNumber(firstName);
});
