...
test('Assert manager can search customer by Postal Code', async ({ page }) => {
 ...
 const customersListPage = new CustomersListPage(page);
  ...
  await customersListPage.findCustomerByPostalCode(postalCode);
  await customersListPage.checkCustomerPostCode(postalCode);
  await customersListPage.assertSearchShowsOnlyOneResult();
});
